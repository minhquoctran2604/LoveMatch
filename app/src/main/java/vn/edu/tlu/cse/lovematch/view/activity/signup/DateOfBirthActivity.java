...
public class xDateOfBirthActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnNext.setOnClickListener(v -> {
            ...
            userRepository.updateUserField("dob", dateOfBirth, new xUserRepository.OnUserActionListener() {
                @Override
                public void onSuccess() {
                    Intent intent = new Intent(xDateOfBirthActivity.this, vn.edu.tlu.cse.lovematch.view.activity.main.MainActivity.class);
                    startActivity(intent);
                }

                @Override
                public void onFailure(String errorMessage) {
                    Toast.makeText(xDateOfBirthActivity.this, "Lỗi khi cập nhật ngày sinh: " + errorMessage, Toast.LENGTH_SHORT).show();
