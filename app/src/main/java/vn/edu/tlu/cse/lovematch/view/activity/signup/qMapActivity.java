...
public class qMapActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (fromSettings) {
            ...
            btnSaveDistance.setOnClickListener(v -> {
                ...
                editor.apply();
                Toast.makeText(qMapActivity.this, "Đã lưu phạm vi tìm kiếm: " + newDistance + " km", Toast.LENGTH_SHORT).show();
            ...
            skipButton.setOnClickListener(v -> {
                ...
                startActivity(new Intent(qMapActivity.this, MainActivity.class));
                finish();
            });
        }
    }
