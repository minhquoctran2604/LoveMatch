...
import vn.edu.tlu.cse.lovematch.controller.nSwipeController;
...
public class nSwipeFragment extends Fragment {

    private static final String TAG = "nSwipeFragment";
    ...
    public void showMatchDialog(String matchedUserName, String chatId, qUser otherUser) {
        ...
        try {
            ...
            if (otherUser == null) {
                ...
                Log.d(TAG, "showMatchDialog: otherUser UID: " + otherUser.getUid());
                Log.d(TAG, "showMatchDialog: otherUser Name: " + otherUser.getName());
                if (otherUser.getPhotos() == null) {
                    Log.e(TAG, "showMatchDialog: otherUser.getPhotos() is null!");
                } else if (otherUser.getPhotos().isEmpty()) {
                    Log.w(TAG, "showMatchDialog: otherUser.getPhotos() is empty!");
                } else {
                    Log.d(TAG, "showMatchDialog: otherUser.getPhotos() size: " + otherUser.getPhotos().size());
                    Log.d(TAG, "showMatchDialog: otherUser.getPhotos().get(0): " + otherUser.getPhotos().get(0));
                }
            }
