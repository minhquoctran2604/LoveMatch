...
public class nUserGridAdapter extends RecyclerView.Adapter<nUserGridAdapter.UserViewHolder> {

    private static final String TAG = "nUserGridAdapter";
    private List<qUser> userList;
    private final Consumer<qUser> onUserClicked;
    private double currentLatitude;
    private double currentLongitude;
    private boolean showActionButtons;
    private Consumer<qUser> onLikeClicked;
    private Consumer<qUser> onDislikeClicked;

    public nUserGridAdapter(List<qUser> userList, Consumer<qUser> onUserClicked, double currentLatitude, double currentLongitude) {
    ...
    public void setShowActionButtons(boolean show, Consumer<qUser> onLikeClicked, Consumer<qUser> onDislikeClicked) {
    ...
    public void updateList(List<qUser> newList) {
        ...
        // Không gọi notifyDataSetChanged() ở đây, vì nLikeFragment đã sử dụng DiffUtil
    }
